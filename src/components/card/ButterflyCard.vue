...
<template>
    <article class="card">
        ...
        <div class="card-text">
            ...
            <h5><em>({{butterfly.described}})</em></h5>
...
.card-image.background{
  background-image: url("https://www.monaconatureencyclopedia.com/wp-content/uploads/2022/01/1-Lymantria-dispar-%C2%A9-Jason-McCombe.jpg" );
